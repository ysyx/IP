...
<html>
    ...
    <body>
        ...
        <div class="row">
	      ...
	      action="ReservationSystem/venue/addimage" >
        ...
        <c:forEach var="book" items="${imageUrlList}">
            <div class="row" style="display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;">
                <div class="col-md-offset-2 col-md-4 col-sm-offset-1 col-sm-md4">
                    <img style='max-width: 500px;width:100%;max-height: 100px; height:100%;' src="ReservationSystem/asset/images/<% out.println(request.getParameter("venue_id")); %>/${book}" />
                </div>
                <div  class=" col-md-offset-1 col-md-2 col-sm-2">
                    <form  action="ReservationSystem/venue/deleteimage" method="get" style="top:45%;position: absolute;">
